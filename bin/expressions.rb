...
class Expression
  ...
  def self.parsed_expressions_num_symbols(expressions)
    vars = []
    expressions.each { |expression| vars.concat expression.num_symbols }
    vars
  end
  ...
  def self.parsed_expressions_text_symbols(expressions)
    strs = []
    expressions.each { |expression| strs.concat expression.text_symbols }
    strs
  end
...
class UserFunctionDefinition
  attr_reader :name, :arguments, :sigils, :signature, :expression, :numerics,
              :num_symbols, :strings, :booleans, :text_symbols, :variables,
...
class Assignment
  attr_reader :warnings, :numerics, :num_symbols, :strings, :booleans,
              :text_symbols, :variables, :operators, :functions, :userfuncs,
