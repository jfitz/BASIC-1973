...
Returns control to the original statement after an error occurs (and is presumably handled).

Syntax; RESUME

Control returns to the statement which experienced the error.
...
In this example program, if the file exists and BASIC can open it, lines 10 through 999 are executed and lines 4000 through 4040 are not used.
