...
cp bin/* test/ahl/data/$TESTNAME/* tests/$TESTNAME
echo testbed ready
...
diff tests/$TESTNAME/stdout.txt test/ahl/ref/$TESTNAME/stdout.txt
((ECODE+=$?))
echo Comparing list...
diff tests/$TESTNAME/list.txt test/ahl/ref/$TESTNAME/list.txt
((ECODE+=$?))
echo Comparing pretty...
diff tests/$TESTNAME/pretty.txt test/ahl/ref/$TESTNAME/pretty.txt
((ECODE+=$?))
echo compare done
