...
bash test/bin/run_coan_test.sh prog-5-1-a
((ECODE+=$?))
bash test/bin/run_coan_test.sh prog-5-1-b
((ECODE+=$?))
bash test/bin/run_coan_test.sh prog-5-1-c
((ECODE+=$?))
bash test/bin/run_coan_test.sh prog-5-1-d
((ECODE+=$?))

bash test/bin/run_coan_test.sh prog-5-2-c
((ECODE+=$?))
bash test/bin/run_coan_test.sh prog-5-2-d
((ECODE+=$?))
bash test/bin/run_coan_test.sh prog-5-2-e
((ECODE+=$?))

bash test/bin/run_coan_test.sh prog-5-3-a
((ECODE+=$?))
bash test/bin/run_coan_test.sh prog-5-3-b
((ECODE+=$?))
