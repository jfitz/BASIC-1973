...
((ECODE+=$?))
bash "$TESTROOT/bin/run_test.sh" "$TESTROOT" "$TESTBED" unit multistatement
((ECODE+=$?))
...
((ECODE+=$?))
bash "$TESTROOT/bin/run_test.sh" "$TESTROOT" "$TESTBED" unit dataread_t
((ECODE+=$?))
...
((ECODE+=$?))
bash "$TESTROOT/bin/run_test.sh" "$TESTROOT" "$TESTBED" unit input_t
((ECODE+=$?))
...
bash "$TESTROOT/bin/run_test.sh" "$TESTROOT" "$TESTBED" unit ifthen_ge_t
((ECODE+=$?))
bash "$TESTROOT/bin/run_test.sh" "$TESTROOT" "$TESTBED" unit ifthen_gt_t
((ECODE+=$?))
bash "$TESTROOT/bin/run_test.sh" "$TESTROOT" "$TESTBED" unit ifthen_le_t
((ECODE+=$?))
bash "$TESTROOT/bin/run_test.sh" "$TESTROOT" "$TESTBED" unit ifthen_lt_t
((ECODE+=$?))
bash "$TESTROOT/bin/run_test.sh" "$TESTROOT" "$TESTBED" unit ifthen_ne_t
((ECODE+=$?))
bash "$TESTROOT/bin/run_test.sh" "$TESTROOT" "$TESTBED" unit ifthen_eq_t
((ECODE+=$?))
...
((ECODE+=$?))
bash "$TESTROOT/bin/run_test.sh" "$TESTROOT" "$TESTBED" unit print_t1
((ECODE+=$?))

bash "$TESTROOT/bin/run_test.sh" "$TESTROOT" "$TESTBED" unit let_n
((ECODE+=$?))
bash "$TESTROOT/bin/run_test.sh" "$TESTROOT" "$TESTBED" unit letless_n
((ECODE+=$?))
bash "$TESTROOT/bin/run_test.sh" "$TESTROOT" "$TESTBED" unit let_t
((ECODE+=$?))
...
((ECODE+=$?))
bash "$TESTROOT/bin/run_test.sh" "$TESTROOT" "$TESTBED" unit letless_targets
((ECODE+=$?))
...
((ECODE+=$?))
bash "$TESTROOT/bin/run_test.sh" "$TESTROOT" "$TESTBED" unit multi_gosub
((ECODE+=$?))
...
((ECODE+=$?))
bash "$TESTROOT/bin/run_test.sh" "$TESTROOT" "$TESTBED" unit multi_fornext
((ECODE+=$?))
...
((ECODE+=$?))
bash "$TESTROOT/bin/run_test.sh" "$TESTROOT" "$TESTBED" unit function_rnd_0
((ECODE+=$?))
...
((ECODE+=$?))
bash "$TESTROOT/bin/run_test.sh" "$TESTROOT" "$TESTBED" unit function_len
((ECODE+=$?))
bash "$TESTROOT/bin/run_test.sh" "$TESTROOT" "$TESTBED" unit function_chr
((ECODE+=$?))
bash "$TESTROOT/bin/run_test.sh" "$TESTROOT" "$TESTBED" unit function_asc
((ECODE+=$?))

bash "$TESTROOT/bin/run_test.sh" "$TESTROOT" "$TESTBED" unit function_pack
((ECODE+=$?))
bash "$TESTROOT/bin/run_test.sh" "$TESTROOT" "$TESTBED" unit function_unpack
((ECODE+=$?))
