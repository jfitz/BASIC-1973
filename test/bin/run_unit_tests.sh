...
((ECODE+=$?))
bash test/bin/run_unit_test.sh multistatement
((ECODE+=$?))
...
((ECODE+=$?))
bash test/bin/run_unit_test.sh dataread_t
((ECODE+=$?))

bash test/bin/run_unit_test.sh input
((ECODE+=$?))
bash test/bin/run_unit_test.sh input_t
((ECODE+=$?))
...
bash test/bin/run_unit_test.sh ifthen_ge_t
((ECODE+=$?))
bash test/bin/run_unit_test.sh ifthen_gt_t
((ECODE+=$?))
bash test/bin/run_unit_test.sh ifthen_le_t
((ECODE+=$?))
bash test/bin/run_unit_test.sh ifthen_lt_t
((ECODE+=$?))
bash test/bin/run_unit_test.sh ifthen_ne_t
((ECODE+=$?))
bash test/bin/run_unit_test.sh ifthen_eq_t
((ECODE+=$?))
...
((ECODE+=$?))
bash test/bin/run_unit_test.sh print_t1
((ECODE+=$?))

bash test/bin/run_unit_test.sh let_n
((ECODE+=$?))
bash test/bin/run_unit_test.sh letless_n
((ECODE+=$?))
bash test/bin/run_unit_test.sh let_t
((ECODE+=$?))
...
((ECODE+=$?))
bash test/bin/run_unit_test.sh letless_targets
((ECODE+=$?))
...
((ECODE+=$?))
bash test/bin/run_unit_test.sh multi_gosub
((ECODE+=$?))
...
((ECODE+=$?))
bash test/bin/run_unit_test.sh multi_fornext
((ECODE+=$?))
...
((ECODE+=$?))
bash test/bin/run_unit_test.sh function_rnd_0
((ECODE+=$?))
