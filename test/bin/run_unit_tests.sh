...
((ECODE+=$?))
bash test/bin/run_test.sh unit multistatement
((ECODE+=$?))
...
((ECODE+=$?))
bash test/bin/run_test.sh unit dataread_t
((ECODE+=$?))
...
bash test/bin/run_test.sh unit ifthen_ge_t
((ECODE+=$?))
bash test/bin/run_test.sh unit ifthen_gt_t
((ECODE+=$?))
bash test/bin/run_test.sh unit ifthen_le_t
((ECODE+=$?))
bash test/bin/run_test.sh unit ifthen_lt_t
((ECODE+=$?))
bash test/bin/run_test.sh unit ifthen_ne_t
((ECODE+=$?))
bash test/bin/run_test.sh unit ifthen_eq_t
((ECODE+=$?))
...
((ECODE+=$?))
bash test/bin/run_test.sh unit print_t1
((ECODE+=$?))

bash test/bin/run_test.sh unit let_n
((ECODE+=$?))
bash test/bin/run_test.sh unit letless_n
((ECODE+=$?))
bash test/bin/run_test.sh unit let_t
((ECODE+=$?))
...
((ECODE+=$?))
bash test/bin/run_test.sh unit letless_targets
((ECODE+=$?))
...
((ECODE+=$?))
bash test/bin/run_test.sh unit multi_gosub
((ECODE+=$?))
...
((ECODE+=$?))
bash test/bin/run_test.sh unit multi_fornext
((ECODE+=$?))
...
((ECODE+=$?))
bash test/bin/run_test.sh unit function_rnd_0
((ECODE+=$?))
