...
7 OPEN "PRPRTY" AS FILE 1: DIM #1 ,Q$(40%)=25,L%(40),P(40%),R(40%)
8 FOR I=1 TO 39:L%(I),H%(I)=0:NEXT I:FOR I=1 TO 8:U(I)=0:NEXT I
9 DEF FNR=(H%(I(Z))*R(I(Z))*10%)
10 OPEN "MESAJ" AS FILE 3: DIM #3,C$(10)=50%,Z$(10)=80%,M$(20)=50%
...
3206 IF L%(16)=Z AND L%(18)=Z ANO L%(19)=Z THEN PRINT "HOW MANY HOUSES AT $100 EACH DO YOU WANT ON":PRINT G$(16)" "G$(18)" "G$(19);:INPUT U:GOSUB 3256
