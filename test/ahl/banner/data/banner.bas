...
340 GOTO270 
345 FORX=1TOA\PRINTTAB(S);G$;GS\NEXTX\GOTO270
...
700 FORX=1TOA\PRINTTAB(S);G$;GS;\PRINTTAB(8*L+S);GS;G$\NEXTX\RETURN
710 IFA=1THEN720\GOTO730
720 LETA=1
730 FORX=1TOA\PRINTTAB(4*L*S);G$;G$\NEXTX\RETURN
740 FORX=1TOA\PRINTTAB(S);G$;GS\NEXTX\RETURN
750 FORX=1TOA\PRINTTAB(S);G$;G$;G$;G$\NEXTX\RETURN
760 FORY=1TOA\PRINTTAB(S);GS;G$;G$;G$;G$;G$;HS;H$;G$;G$\NEXTY\RETURN
...
870 PRINTTAB(7*L-X*S);GS;G$;G$\NEXT X\RETURN
880 FORX=0TO6*LSTEP6*L/C\PRINTTAB(X+S);G$;G$;G$;GS\NEXTX\RETURN
890 FORX=6*LTO0STEP-6*L/C\PRINTTAB(X+S);G$;G$;GS;G$\NEXTX\RETURN
900 FORX=0TO7*LSTEP(14*L)/(C*6)\PRINTTAB(X+S);GS;G$;G$;
...
970 FOR X=7*LTO4*LSTEP-4*L/C\PRINTTAB(X*S);G$;GS;G$\NEXTX\RETURN
980 DATA" ","  ","   ","    ","     ","      ",""
