...
26 REM *** BY STUDENTS OF LEXINGTON HIGH SCHOOL, MA AND MODIFIED FOR
25 REM *** RSTS/E BY DAVE AHL OF DIGITAL 11/45 GROUP
20 DIM A1(6), A(3), B(3)
40 RANDOMIZE:V=0:T=255
70 INPUT "GAME OF BAGLES. WOULD VOU LIKE THE RULES (YES OR NO)",A$
90 IF A$="NO" THEN 150
100 PRINT:PRINT "I AM THINKING OF A THREE-DIGIT NUMBER. TRV TO GUESS"
110 PRINT "MY NUMBER AND I WILL GIVE VOU CLUES AS FOLLOWS:"
...
350 C=0:D=0
360 FOR J=1 TO 2
370 IF A1(J)<>B(J+1) THEN 390
380 C=C+1
390 IF A1(J+1)<>B(J) THEN 410
400 C=C+1
410 NEXT J
420 IF A1(1)<>B(3) THEN 440
430 C=C+1
440 IF A1(3)<>B(1) THEN 460
450 C=C+1
460 FOR J=1 TO 2
