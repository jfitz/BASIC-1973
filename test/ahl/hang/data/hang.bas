...
I80 FOR I=1 TO 26:& N$(I);:IF N(I+1)="" THEN 200
190 PRINT ", ";:NEXT I
200 &:&:FOR I=1 TO L:& D$(I);:NEXT I:&:&
210 INPUT "WHAT IS YOUR GUESS";G$:R=0
220 FOR I=1 TO 26:IF N$(G)="" THEN 250
...
481 P$(4,8)=".":P$(4,9)=")":P$(5,6)="-":P$(5,7)="-":P$(5,8)="-":GOTO 500
490 P$(I,7)="X" FOR I=6 TO 9:GOTO 580
500 P4(I,I-1)="\" FOR I = 4 TO 7:GOTO 580
