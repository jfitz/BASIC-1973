...
4450 O3$=O2$+"        STARDATE         #####"
4455 PRINT USING O3$,MID(O$,25,3),MID(O$,28,3),MID(O$,31,3),MID(O$,34,3),MID(O$,37,3),MID(O$,40,3),MID(O$,43,35),MID(O$,46,3)
4560 O4$=O2$+"        CONDITION        \    \"
4565 PRINT USING O4$,MID(O$,49,3),MID(O$,52,3),MID(O$,55,3),MID(O$,58,3),MID(O$,61,3),MID(O$,64,3),MID(O$,67,35),MID(O$,70,3)
4570 O5$=O2$+"        QUADRANT         "
4475 PRINT USING O5$,MID(R$,1,3),MID(R$,4,3),MID(R$,7,3),MID(R$,10,3),MID(R$,13,3),MID(R$,16,3),MID(R$,19,35),MID(R$,22,3)
